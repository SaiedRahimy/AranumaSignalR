...
namespace AranumaSignalRWinform.Client.TCP
{
    public class TcpConnection : ConnectionContext, IConnectionInherentKeepAliveFeature//: IConnection
    {
        ...
        public async ValueTask<ConnectionContext> StartAsync()
        {
            ...
            //var pair = DuplexPipe.CreateConnectionPair(PipeOptions inputOptions, PipeOptions outputOptions)
